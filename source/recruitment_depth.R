#=============================================================================#
# Name   : recruitment_depth
# Author : Jorge Flores
# Date   : 
# Version:
# Aim    : Calculate the mean, the lower and upper limits of the error bars
#          (confidence interval or standard error) for each release depth
# URL    : This reads and calculates recruits for each spawning depth
#=============================================================================#
recruitment_depth = function(dataset, a = 0.05){
