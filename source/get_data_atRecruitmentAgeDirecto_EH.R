#=============================================================================#
# Name   : get_data_atRecruitmentAgeDirecto_EH
...
# URL    : 
#=============================================================================#
get_data_atRecruitmentAgeDirecto_EH <- function(
    dirpath            = NULL
    ,firstdrifter      = 1
    ,lastdrifter       = 5000
    ,firsttime         = 1
  ...
  # EHj = Maturity threshold at metamorphosis
  ...
  get_data_atRecruitmentAge_file <- function(filename){
    ...
    recruited <- as.vector(t(ncvar_get(nc, 'E_H') >= EHj))
