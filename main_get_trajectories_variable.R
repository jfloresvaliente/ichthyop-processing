#=============================================================================#
# Name   : main_get_trajectories_variable
...
library(fields)
library(stringr)
source('source/get_trajectories_variable.R')
...
for(i in 1:12){
  ...
  for(j in 1:length(month)){
    ...
    print(ncfile)
    trajs <- get_trajectories_variable(ncfile = ncfile
  ...
  RData <- paste0(dirpath, '/results/', 'trajectories_variableM', i, '.Rdata')
