#=============================================================================#
# Name   : make_surface_map_MESO_ROMS
# Author : 
# Date   : 
# Version:
...
png(filename = paste0(dirpath, 'surface_map_MESO_ROMS.png'), width = 850, height = 850, res = 120)
par(mar = c(4.5,4.5,.5,.5))
image.plot(lon, lat, vari*mask, xlab = '', ylab = '', zlim = c(0,10), axes = F,
