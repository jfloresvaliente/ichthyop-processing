#=============================================================================#
# Name   : plot_ROMS_CT_hovmuller_latitude
# Author : Jorge Flores
# Date   : 
# Version:
# Aim    :
...
if(sp == 'encrasicolus'){
  ...
  png_name <- paste0(dirpath, sufijo, '/', sufijo, '_', namevar, 'CTcase1', sp, '_hovmuller_latitude.png')
  ...
  png_name <- paste0(dirpath, sufijo, '/', sufijo, '_', namevar, 'CTcase2', sp, '_hovmuller_latitude.png')
