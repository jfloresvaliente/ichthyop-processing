...
dat1 <- read.table('C:/Users/jflores/Documents/JORGE/ICHTHYOP/10kmparent/FISICA/out/results_30days/ichthyop_output.csv', header = T, sep = ';')
dat2 <- read.table('C:/Users/jflores/Documents/JORGE/ICHTHYOP/10kmparent/DEBf1/out/results/ichthyop_output.csv', header = T, sep = ';')
dat3 <- read.table('C:/Users/jflores/Documents/JORGE/ICHTHYOP/10kmparent/DEB/k_x1.6/out/results/ichthyop_output.csv', header = T, sep = ';')
