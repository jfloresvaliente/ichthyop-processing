...
dirpath <- 'E:/ICHTHYOP/10kmparent/DEB_TC5_TCseuil0.052abj_shape_pecq/case1_kx0.4/'
ymax    <- c(0,30)
...
mtext(side = 1, line = 2.3, cex = 1, font = 2, text = 'Spawning Latitude')
# mtext(side = 2, line = 2.5, cex = 1, font = 2, text = ylab)
...
mtext(side = 1, line = 2.3, cex = 1, font = 2, text = 'Spawning Depth [m]')
mtext(side = 2, line = 2.5, cex = 1, font = 2, text = ylab)
