#=============================================================================#
# Name   : barplot_and_curves_N_constant
...
# URL    : 
#=============================================================================#
dirpath <- 'C:/Users/jflores/Documents/ICHTHYOP/10kmparent/DEB_TC5/out_simu5/results_no_shelf/'
ymax    <- 1
...
png(filename = paste0(dirpath, 'barplot_and_curvesN_constant.png'), height = 750, width = 1050, res = 120)
