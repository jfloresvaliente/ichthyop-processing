dirpath <- 'C:/Users/jflores/Documents/JORGE/TESIS/TESIS_PHD/DEB/ichthyop_DEB/Engraulis_encrasicolus_param/'
...
# a <- c(0.00932)
# b <- c(2.67900)
# model_source <- c('Verdiell et al 2006')

# a <- c(0.0038)
# b <- c(3.1939)
# model_source <- c('Sinovcic 2004')
...
png('C:/Users/jflores/Desktop/LW_encrasicolus2.png', height = 850, width = 850, res = 120)
par(mar = c(4,4,2,2))
