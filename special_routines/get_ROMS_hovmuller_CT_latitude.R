#=============================================================================#
# Name   : get_ROMS_hovmuller_CT_latitude
# Author : Jorge Flores
# Date   : 
# Version:
# Aim    :
...
Rdata <- paste0(outpath, sufijo, '_', toupper(namevar), 'CTcase1', sp, '_hovmuller_latitude',0,z_depth,'m.Rdata')
...
Rdata <- paste0(outpath, sufijo, '_', toupper(namevar), 'CTcase2', sp, '_hovmuller_latitude',0,z_depth,'m.Rdata')
