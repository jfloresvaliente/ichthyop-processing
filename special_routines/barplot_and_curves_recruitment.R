...
#=============================================================================#
dat   <- read.table(file = paste0(dirpath,'/results/ichthyop_output.csv'), header = T, sep = ';')
...
png(filename = paste0(dirpath, '/results/barplot_and_curves.png'), height = 750, width = 1050, res = 120)
