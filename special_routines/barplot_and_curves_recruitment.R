...
# cols <- c('grey5', 'white', 'white')
cols <- c('grey5', 'grey50', 'white')
# cols <- c('grey5', 'grey50', 'grey80')
# cols <- c('white', 'white', 'white')

# border <- c('black', 'white', 'white')
border <- c('black', 'black', 'white')
# border <- c('black', 'black', 'black')


meses <- c('Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec')

png(filename = paste0(dirpath, 'barplot_and_curves5.png'), height = 750, width = 1050, res = 120)
