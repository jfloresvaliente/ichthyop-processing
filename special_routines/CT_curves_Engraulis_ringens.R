...
# Date   : 
# Version:
# Aim    : calculate and plot temperature correction curve of the DEB model
# URL    : 
#=============================================================================#
dirpath  <- 'C:/Users/jflores/Desktop/' # Outpath to plot
out_name <- 'curves3' # png file name
...
text_size <- 1 # Size of legend text
#=============================================================================#
...
box(lwd = 2)
mtext(side = 1, line = 2.5, font = 2, cex = 1.2, text = 'Temprature (ºC)')
mtext(side = 2, line = 2.5, font = 2, cex = 1.2, text = 'Correction factor')
...
lines(Temp - T_K, TC_5, lwd = 5.0, col = 'red')
...
s_H_ratio <- (1 + exp(T_AH/T_H - T_AH/T_ref)) / (1 + exp(T_AH/T_H - T_AH/Temp))
TC_5      <- s_A * ((Temp <= T_ref) * s_L_ratio + (Temp > T_ref) * s_H_ratio)
lines(Temp - T_K, TC_5, lwd = 3.5, col = 'blue')
