...
out_name <- 'CTcurves_Engraulis_ringens'
...
text(27, 1.3, adj = 0, font = 2, col = 'blue', cex = text_size, bquote(paste('CT'[max]*' = ', .(Temp[which.max(CT_5)]-T_K))))
