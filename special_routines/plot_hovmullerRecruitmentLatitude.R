...
# Plot Climatology
Rdata    <- paste0(dirpath, '/hovmuller/hovmullerRecruitmentLatitude', lat_div, 'degrees.Rdata')
load(Rdata)
...
png_name <- paste0(dirpath, '/hovmuller/hovmullerRecruitmentLatitude', lat_div, 'degrees.png')
...
# Plot Interanual
Rdata    <- paste0(dirpath, '/hovmuller/hovmullerRecruitmentLatitudeByYear', lat_div, 'degrees.Rdata')
load(Rdata)
...
png_name <- paste0(dirpath, '/hovmuller/hovmullerRecruitmentLatitudeByYear', lat_div, 'degrees.png')
