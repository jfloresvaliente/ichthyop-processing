...
dirpath  <- 'C:/Users/jflores/Documents/ICHTHYOP/10kmparent/DEB_TC5_TCseuil0.052abj/case1kx0.2oneyear/'
...
isolines2 <- round(seq(zlim[1], zlim[2], 5), 2) # Isolines to be plotted
