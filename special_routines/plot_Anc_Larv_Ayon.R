...
# PNG plot
png(filename = paste0(outpath, 'Anch_egg.png'), width = 700, height = 750, res = 120)
grid.arrange(p1, nrow = 1)
dev.off()

png(filename = paste0(outpath, 'Anch_lar.png'), width = 700, height = 750, res = 120)
grid.arrange(p2, nrow = 1)
dev.off()

# TIFF plot
tiff(filename = paste0(outpath, 'Anch_egg.tiff'), width = 700, height = 750, res = 120)
grid.arrange(p1, nrow = 1)
dev.off()

tiff(filename = paste0(outpath, 'Anch_lar.tiff'), width = 700, height = 750, res = 120)
grid.arrange(p2, nrow = 1)
dev.off()

#SVG plot
svg(filename = paste0(outpath, 'Anch_egg.svg'), width = 7.00, height = 7.50)
grid.arrange(p1, nrow = 1)
dev.off()

svg(filename = paste0(outpath, 'Anch_lar.svg'), width = 7.00, height = 7.50)
grid.arrange(p2, nrow = 1)
dev.off()
