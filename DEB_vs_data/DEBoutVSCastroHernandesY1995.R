#=============================================================================#
# Name   : DEBoutVSCastroHernandesY1995
# Author : Jorge Flores-Valiente
# Date   :
# Version:
# Aim    : Plot DEB_out files vs CastroHernandesY1995 data
# URL    :
#=============================================================================#
# Type of length: standard (Ls, mm)
# Time: age (days)
# Averiguar Temperatura (potencialmente: 11ºC)
...
ggname <- paste0(dirpath, 'CastroHernandesY1995fMeanSD.png')
ggplot(data = dat)+
...
ggname <- paste0(dirpath, 'CastroHernandesY1995fMaxMin.png')
ggplot(data = dat)+
  geom_line(data = sum_dat, mapping = aes(x = t, y = mean, colour = temp), size = 2)+
...
ggname <- paste0(dirpath, 'CastroHernandesY1995f1.png')
ggplot(data = dat)+
...
ggname <- paste0(dirpath, 'CastroHernandesY1995f.png')
ggplot(data = dat)+
