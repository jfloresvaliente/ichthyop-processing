...
png('C:/Users/jflores/Desktop/DEB_vs_FishBase.png', width = 850, height = 850, res = 120)
par(mar = c(4,4,1,1))
plot(1, type = 'n', axes = F,
     xlab = '', ylab = '',
     xlim = c(0,1500), ylim = c(0,20))
...
legend('topleft', bty = 'n',
       ...
       legend = c('DEB 15ºC', 'DEB 18ºC'), text.font = 2,
       text.col = cols, lty = 1, col = cols)

legend('topright', bty = 'n',
       xjust = 0, yjust = 0,
       y.intersp = .9, x.intersp = .5,
       legend = c('FishBase 15ºC', 'FishBase 18ºC'), text.font = 2,
